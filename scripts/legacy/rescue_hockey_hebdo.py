...
def main():
    print("[*] Sauvetage des articles Hockey Hebdo...")
    ...
    cur.execute("""
        ...
        FROM \"Article\" 
        WHERE (source LIKE '%Hockey Hebdo%')
    ...
    total = len(articles)
    print(f"[*] {total} articles Hockey Hebdo à traiter.")
    ...
    cur.close()
    conn.close()
    print(f"\n[*] Terminé. {repaired} articles Hockey Hebdo sauvés.")
