...
def main():
    print("[*] Sauvetage des articles Libération...")
    ...
    total = len(articles)
    print(f"[*] {total} articles Libération à traiter.")
    ...
    cur.close()
    conn.close()
    print(f"\n[*] Terminé. {repaired} articles Libération sauvés.")
